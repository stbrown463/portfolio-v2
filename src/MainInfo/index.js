...
const MainInfo = (props) => {
    ...
    <div className="main-container">
      <div className="picture-info-flex">
	        ...
	        <p className="description-main">I'm a full stack web developer eager to work in a demanding, creative enviornment that reflects my passion for learning and problem solving.</p>
	        <p className="email-main">Email: stbrown463@gmail.com@gmail.com</p>
